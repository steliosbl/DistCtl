namespace DistCtl
{
    internal sealed class Config
    {
        ...
        public Config(bool enableLiveErrors, bool enableLocalConsole, bool enableJobPreload, bool enableRedundancy, bool enableLoadBalancng, bool enableAutoRestart, int updateDelay, int timeoutDuration, string schematicFilename, string preLoadFilename)
        {
